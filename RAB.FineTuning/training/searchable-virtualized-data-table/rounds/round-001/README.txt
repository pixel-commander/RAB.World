...
Use capture-change begin/finish around every focused edit. The session evidence
store holds exact file versions once by hash; changes/ links before/after versions.
