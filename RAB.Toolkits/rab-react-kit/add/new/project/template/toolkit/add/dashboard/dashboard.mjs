...
import { run as createPage } from '../page/page.mjs';
...
export const run=async({options,helpers,context})=>{
  ...
  const page={result:await createPage({options:{...options,location:pageLocation},helpers,context,
    signalType:'component',signalTemplateUrl:new URL('./template/settings.json',import.meta.url)})};
